...
instruction_encoding InstructionTable8086[] = {
    ...
    {Op_push,
     {{Bits_Literal, sizeof("11111111") - 1, 0, 0b11111111},
      ...
      {Bits_W, 0, 0, 1},
      {Bits_D, 0, 0, 1}}},
    {Op_push, {{Bits_Literal, sizeof("01010") - 1, 0, 0b01010}, {Bits_REG, 3}, {Bits_W, 0, 0, 1}, {Bits_D, 0, 0, 1}}},
    {Op_push,
     {{Bits_Literal, sizeof("000") - 1, 0, 0b000},
      {Bits_SR, 2},
      {Bits_Literal, sizeof("110") - 1, 0, 0b110},
    ...
    {Op_pop,
     {{Bits_Literal, sizeof("10001111") - 1, 0, 0b10001111},
      ...
      {Bits_W, 0, 0, 1},
      {Bits_D, 0, 0, 1}}},
    {Op_pop, {{Bits_Literal, sizeof("01011") - 1, 0, 0b01011}, {Bits_REG, 3}, {Bits_W, 0, 0, 1}, {Bits_D, 0, 0, 1}}},
    {Op_pop,
     {{Bits_Literal, sizeof("000") - 1, 0, 0b000},
      {Bits_SR, 2},
    ...
    {Op_inc,
     {{Bits_Literal, sizeof("1111111") - 1, 0, 0b1111111},
      ...
      {Bits_RM, 3},
      {Bits_D, 0, 0, 1}}},
    {Op_inc, {{Bits_Literal, sizeof("01000") - 1, 0, 0b01000}, {Bits_REG, 3}, {Bits_W, 0, 0, 1}, {Bits_D, 0, 0, 1}}},
    ...
    {Op_dec,
     {{Bits_Literal, sizeof("1111111") - 1, 0, 0b1111111},
      ...
      {Bits_RM, 3},
      {Bits_D, 0, 0, 1}}},
    {Op_dec, {{Bits_Literal, sizeof("01001") - 1, 0, 0b01001}, {Bits_REG, 3}, {Bits_W, 0, 0, 1}, {Bits_D, 0, 0, 1}}},
    {Op_neg,
    ...
    {Op_ret,
     {{Bits_Literal, sizeof("11000010") - 1, 0, 0b11000010},
      ...
      {Bits_WMakesDataW, 0, 0, 1},
      {Bits_W, 0, 0, 1}}},
    {Op_retf, {{Bits_Literal, sizeof("11001011") - 1, 0, 0b11001011}, {Bits_Far, 0, 0, 1}}},
    {Op_retf,
